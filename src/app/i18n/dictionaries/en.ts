...
export const EN_DICTIONARY = {
    ...
    'drawing.trail': 'Trail',
    'drawing.trail.short': 'Short',
    'drawing.trail.medium': 'Medium',
    'drawing.trail.long': 'Long',
    ...
    'drawing.emoji': 'Emoji',
    'drawing.size': 'Size',
    'drawing.size.thin': 'Small',
    'drawing.size.medium': 'Medium',
    'drawing.size.thick': 'Large',
    'drawing.tool.setup': 'Set up the tool',
    'emoji.search': 'Search emoji',
    'emoji.search.empty': 'Nothing answers to that',
    'emoji.recent': 'Recently used',
    'emoji.group.0': 'Smileys',
    'emoji.group.1': 'People',
    'emoji.group.3': 'Nature',
    'emoji.group.4': 'Food',
