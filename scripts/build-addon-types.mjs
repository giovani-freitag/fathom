 ...
 * rather than over it. With `--dts` it writes the declarations on their own
 * instead, which is what a repository of readings typechecks against.
 *
...
writeFileSync(OUT, WANTS_DECLARATIONS
    ? `// Generated by Fathom's scripts/build-addon-types.mjs. Do not edit.
//
