import { LiquidityArchiveService } from '../archive/liquidity-archive-service.ts';
import { PostgresService } from '../archive/postgres-service.ts';
import {
    BINANCE_ENDPOINTS,
    type CollectorConfiguration,
    RESILIENCE_SETTINGS,
    WRITE_SETTINGS,
} from './collector-configuration.ts';
import { logInfo, logWarning } from './collector-log.ts';
import { BinanceDepthFeedService } from '../venue/binance-depth-feed-service.ts';
import type { DepthDiff, DepthSnapshot, ExecutedTrade } from '../book/depth-types.ts';
import { OrderBookService } from '../book/order-book-service.ts';
import { LiquidityRecorderService } from './liquidity-recorder-service.ts';
