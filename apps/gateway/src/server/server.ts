...
import { API_ROUTES } from '@fathom/contracts';
import type { LiquidityQueryService, PostgresService } from '@fathom/persistence';
import Fastify, { type FastifyInstance } from 'fastify';
import { existsSync } from 'node:fs';
import { resolve } from 'node:path';
import type { LiveTailService } from '../services/live-tail/live-tail-service.ts';
