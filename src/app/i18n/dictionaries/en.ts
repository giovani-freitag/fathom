...
export const EN_DICTIONARY = {
    ...
    'recording.addPair': 'Record another pair',
    'recording.pickerTitle': 'What this venue offers',
    'recording.done': 'Done',
    'recording.venuesWithoutBook': '{venues} publish no book Fathom can mirror, so there is nothing to record on them.',
    'recording.alreadyOn': 'on the list',
    ...
    'recording.nothingYet': 'Nothing from this venue yet.',
