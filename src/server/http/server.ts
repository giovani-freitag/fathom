...
export class Server {
    ...
    private setupServer(): FastifyInstance {
        ...
        // Methods named rather than left open: the API reads, saves and removes,
        // and nothing else should be reachable by preflight.
        void app.register(cors, { origin: true, methods: ['GET', 'PUT', 'DELETE', 'OPTIONS'] });
